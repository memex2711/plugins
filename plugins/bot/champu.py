...
kick = ["kick", "nikal", "nikaalo", "nikalo"]
promote = ["promote", "adminship", "dedo", "admin"]
fullpromote = ["fullpromote", "fulladmin", "full"]
demote = ["demote", "lele"]
group = ["group"]
channel = ["channel"]

@app.on_message(filters.command(["hampu","hampu"], prefixes=["c", "C"]) & admin_filter)
